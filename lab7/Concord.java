 ...
 * @param comparator 
   ...
   public void printSorted(PrintStream out) {
      ...
      // this commented section include code using Hashmap and output is in poe_hasmap.out and melville_hashmap.out 
	  
	 /*Map<String, Integer> reverseSortedMap = new LinkedHashMap<>();
	 	 
	 //Use Comparator.reverseOrder() for reverse ordering
	 
	 concord.entrySet().stream().sorted(Map.Entry.comparingByValue(Comparator.reverseOrder())) 
	     .forEachOrdered(x -> reverseSortedMap.put(x.getKey(), x.getValue()));
	  
	 System.out.println("Reverse Sorted Map: ");
      System.out.println();
	 
	 for (Map.Entry<String, Integer> curr : reverseSortedMap.entrySet()) {
         out.println(curr.getKey() + " " + curr.getValue());
      }*/
      ...
      ArrayList<Map.Entry<String, Integer>> compList = new ArrayList<>();
      ...
      System.out.println();
   	  ...
   	  for (Map.Entry<String, Integer> curr : compList) {
          out.println(curr.getKey() + " " + curr.getValue());
   	   }
   }
